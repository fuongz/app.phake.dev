            ...
            {selectors ? (
              selectors.map((selector, index) => {
                return (
                  <div
                    key={`selector-${index}`}
                    className="col-span-3 grid grid-cols-10 gap-4"
                  >
                    <div className={`input-control col-span-2`}>
                      <label htmlFor={`type-${selector.key}`}>
                        Type #{selector.key}
                      </label>
                      <select
                        id={`type-${selector.key}`}
                        {...register(`selectors[${index}].type`)}
                      >
                    ...
                    <div className={`input-control col-span-8`}>
                      ...
                      <input
                        ...
                        {...register(`selectors[${index}].value`)}
                      />
                    </div>
                  </div>
                );
                    ...
                    <>
                      <div className="relative">
                        <textarea
                          ...
                          placeholder="Result"
                          rows={15}
                          value={stringNoHtml(noNbsp(value))}
                          disabled
                        />
